...
const forksMarkDown =
  forks.length === 0
    ? `No${nbsp}forks${nbsp}🍴`
    : forks.length === 1
    ? `[One${nbsp}fork:${nbsp}\`${forks[0].name}\`${nbsp}🍴](${
        forks[0].html_url
      })${identicalForks.length > 0 ? " ᐧ " : ""}`
    : `[${forks.length}${nbsp}forks${nbsp}🍴](${
